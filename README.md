...
İlk mesajı zaman dilimini beklemeden denemek için sender terminalinde bir kez `SEND_NOW=1 npm start` çalıştırın. Bu komut tek bir anlık mesaj gönderir; sonraki çalıştırmalarda normal dört saatlik zamanlayıcı için yalnızca `npm start` kullanın.
