...
İki kişinin 1.000 İngilizce kelimeyi 100 gün boyunca birlikte çalıştığı küçük bir web uygulaması. Program ilk erişimde CSV müfredatını bir kez rastgele sıralar ve her gün daha önce kullanılmamış 10 kelime gösterir. İki kişi aynı günlük kelimeleri görür; kalıcı sıra sayesinde yayınlama veya yeniden başlatma kelimeleri değiştirmez. Ekran İstanbul saatiyle 00.00'da otomatik yenilenir. Her kişi telefon numarası ve kendi PIN'iyle girer. Bir kelime o gün üç kez “Ezberledim” olarak işaretlendiğinde tamamlanır; karttaki yıldızlar günlük ilerlemeyi gösterir. Her işaret, gruba kişi adı, kelime, tamamlanan tekrar ve kalan tekrar bilgisini içeren ayrı bir WhatsApp bildirimi sıraya alır. İki saatlik durum mesajlarını da Mac'te çalışan gönderici, birinci kişinin bağlı WhatsApp hesabından seçilen gruba yollar.
...
Anlık mesaj için proje kökünde `npm run local:send-now` çalıştırın; açık olan göndericiye tek gönderim talimatı verir. Durumu `sender/data/sender.log` dosyasından kontrol edin. WhatsApp kütüphanesi mesaj kimliğini doğrudan döndürmezse gönderici, gecikmeli gönderim olayını ve sohbet geçmişini kontrol ederek mesajı doğrular. Hiçbir kanaldan doğrulanamayan gönderimler çift mesajı önlemek için *belirsiz* kaydedilir.
